 ...
 * environment versions ever leave the machine. The OAuth credentials, Search
 * Console data, tool arguments, prompts and the names or values of environment
...
const APP = "mcp-google-search-console";
