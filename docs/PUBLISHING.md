...
(`io.github.A1-x-Tech/mcp-google-search-console`). Check before publishing — all three must
...
2. Point it at `https://github.com/A1-x-Tech/mcp-google-search-console`. LobeHub pulls the
   README, tool list and install config (`npx -y mcp-google-search-console`) automatically.
